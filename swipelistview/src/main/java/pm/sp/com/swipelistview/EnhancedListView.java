...
public class EnhancedListView extends ListView {
    ...
    /**
     * The callback interface used by {@link #setShouldSwipeCallback(pm.sp.com.swipelistview.EnhancedListView.OnShouldSwipeCallback)}
    ...
    public interface OnShouldSwipeCallback {
         ...
         *
         * @param listView The {@link pm.sp.com.swipelistview.EnhancedListView} the item is wiping from.
    ...
    /**
     * The callback interface used by {@link #setDismissCallback(pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback)}
     ...
     * {@link pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback#onDismiss(pm.sp.com.swipelistview.EnhancedListView, int)}
     * to let the user undo the deletion you've done with your {@link pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback}.
    ...
    public abstract static class Undoable {
         ...
         * {@link pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback#onDismiss(pm.sp.com.swipelistview.EnhancedListView, int)} and reinsert
     ...
     * {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(pm.sp.com.swipelistview.EnhancedListView, int)}
     ...
     * from {@link de.timroes.android.listview.EnhancedListView.OnDismissCallback#onDismiss(pm.sp.com.swipelistview.EnhancedListView, int)}.
     ...
     * @throws IllegalStateException when you haven't passed an {@link pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback}
     *      to {@link #setDismissCallback(pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback)} before calling this
     *      method.
     */
     ...
     * By default this is set to {@link pm.sp.com.swipelistview.EnhancedListView.SwipeDirection#BOTH} so that an item
     ...
     * {@link pm.sp.com.swipelistview.EnhancedListView.Undoable#discard()} might not be called for several items, what might
     ...
     * @throws IllegalStateException when this method is called before an {@link pm.sp.com.swipelistview.EnhancedListView.OnDismissCallback}
